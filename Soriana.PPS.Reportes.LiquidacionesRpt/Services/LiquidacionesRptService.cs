...
namespace Soriana.PPS.Reportes.LiquidacionesRpt.Services
{
    public class LiquidacionesRptService
    {
        DA_Reportes Reportes = new DA_Reportes();

        public void GenerarReportes()
        {
            var Liquidaciones = BL_Liquidaciones();
            CreateExcel_Liquidaciones(Liquidaciones);
        }
